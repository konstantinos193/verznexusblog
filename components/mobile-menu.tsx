  ...
  return (
    <>
      ...
      >
        {/* Top line */}
        <div
          className={`absolute ${isOpen ? "rotate-45 top-[21px]" : "top-[14px]"} left-[10px] w-[24px] h-[2px] transition-all duration-300`}
          style={{ backgroundColor: "rgb(153, 153, 153)", borderRadius: "10px" }}
        ></div>

        {/* Bottom line */}
        <div
          className={`absolute ${isOpen ? "-rotate-45 top-[21px]" : "top-[28px]"} left-[10px] w-[24px] h-[2px] transition-all duration-300`}
          style={{ backgroundColor: "rgb(153, 153, 153)", borderRadius: "10px" }}
        ></div>
      </button>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-2">
          <div
            className="w-[82%] md:w-[86%] max-w-[1192px] rounded-[16px] overflow-hidden"
            style={{
              backdropFilter: "blur(5px)",
              backgroundColor: "rgba(11, 11, 14, 0.36)",
            }}
          >
            <div className="p-5">
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  <div
                    className="absolute top-[21px] left-[10px] w-[24px] h-[2px] rotate-45"
                    style={{ backgroundColor: "rgb(153, 153, 153)", borderRadius: "10px" }}
                  ></div>
                  <div
                    className="absolute top-[21px] left-[10px] w-[24px] h-[2px] -rotate-45"
